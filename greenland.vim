...
function! TabulaSettingCurColor()
  ...
  elseif s:CurColor == "red"
    ...
    hi Cursor		guifg=#00007F	guibg=#F78F00
  elseif s:CurColor == "blue"
    hi Cursor		guifg=#00003F	guibg=#00CF4F
...
function! TabulaSettingFlatConstants()
  if s:FlatConstants == 1
    ...
    hi Constant		guifg=#7DDCDB					ctermfg=123
    hi Boolean		guifg=#FDAE3A					ctermfg=123
    hi Character	guifg=#BFE000					ctermfg=148
    hi Float		guifg=#AF87DF					ctermfg=141
    hi Number		guifg=#00E0FF					ctermfg=39
    hi String		guifg=#00FF00	guibg=#004400	ctermfg=46
  endif
endfunction
...
function! TabulaSettingLNumUnderline()
  if s:LNumUnderline == 1
    hi LineNr		guifg=#008F00	guibg=#003030	gui=underline	ctermfg=84	ctermbg=24	cterm=underline
  else
    hi LineNr		guifg=#008F00	guibg=#003030			ctermfg=84	ctermbg=24
  endif
endfunction
...
function! TabulaSettingSearchStandOut()
  if s:SearchStandOut == 0
    hi IncSearch		guifg=#003F00	guibg=#20A8B8	gui=NONE	ctermfg=NONE	ctermbg=22	cterm=NONE
    hi Search		guifg=#003F00	guibg=#41DA81			ctermfg=NONE	ctermbg=18
  elseif s:SearchStandOut == 1
    hi IncSearch	guifg=#D0D0D0	guibg=#20A8B8	gui=underline	ctermfg=252	ctermbg=22	cterm=underline
    hi Search		guifg=#FDAD5D	guibg=#20A8B0	gui=underline	ctermfg=215	ctermbg=18	cterm=underline
  elseif s:SearchStandOut == 2
    hi IncSearch	guibg=#D0D0D0	guifg=#20A8B8	gui=underline	ctermbg=252	ctermfg=22	cterm=underline
    hi Search		guibg=#FDAD5D	guifg=#20A8B0	gui=underline	ctermbg=215	ctermfg=18	cterm=underline
  endif
endfunction
...
"=============================== Font Elements =========================== {{{3
"
hi Normal		guifg=#40FFA0	guibg=#000000			ctermfg=84	ctermbg=23 
...
if version >= 700
    ...
    hi CursorLine		      	guibg=#085344					ctermbg=29
...
hi StatusLine		guifg=#000000	guibg=#3DAE8D	gui=NONE			ctermbg=00	cterm=reverse
hi StatusLineNC		guifg=#44F788	guibg=#387C6C	gui=NONE	ctermfg=72	ctermbg=23	cterm=reverse
...
hi FoldColumn		guifg=#00BBBB	guibg=#0E2E3E			ctermfg=14 	ctermbg=240
hi Folded		guifg=#44DDDD	guibg=#0E2E3E			ctermfg=14 	ctermbg=240
...
hi ModeMsg		guifg=#FFFFFF	guibg=#00A261	gui=NONE	ctermfg=7	ctermbg=4	cterm=NONE
...
hi SpecialKey		guifg=#00A4A4	guibg=#164935
...
if version >= 700
    ...
    hi PmenuThumb      	guifg=#38ff56					ctermfg=3
    hi CursorColumn		    	guibg=#096354					ctermbg=29
    hi CursorLine		      	guibg=#083234					ctermbg=29
    hi Tabline         	guifg=bg	guibg=fg	gui=NONE	ctermfg=NONE	ctermbg=NONE	cterm=reverse,bold
    hi TablineSel      	guifg=#20012e	guibg=#00a675	gui=bold
    hi TablineFill     	guifg=#689C7C
    hi MatchParen      	guifg=#38ff56	guibg=#0000ff	gui=bold	ctermfg=14	ctermbg=21	cterm=bold
...
"------------------------------------------------------------------------------
"
hi Comment		guifg=#00AA00	guibg=#003333	ctermfg=51
...
hi Identifier		guifg=#FDDEAA					ctermfg=215			cterm=NONE
hi Type			guifg=#F29964	guibg=bg	gui=NONE	ctermfg=213
...
function! Tabula()
  ...
  while thisOption >= 1 && thisOption <= 10
    ...
    let thisOption = inputlist([
	  ...
	  \		     "3. CurColor           Set GUI cdarkyellowursor color",
...
"------------------------------------------------------------------------------
"
hi Comment		guifg=#00E587					ctermfg=51
...
hi Normal                  guifg=#A0EFD0 guibg=#000000
hi CursorColumn            guibg=#033344 ctermbg=29
hi SpecialKey              guifg=#A52222 guibg=NONE
hi CursorLine              guibg=#033314 ctermbg=29
hi Identifier              guifg=#44AF70 guibg=#203340
hi Function                guifg=#44AF70
hi Constant                guifg=#00FFAA
hi Statement               guifg=#579FBB guibg=#001111
hi Type                    guifg=#50CF80 guibg=#003050
hi PreProc                 guifg=#3074FF
hi Operator                guifg=#E0FF00 guibg=#101000
hi Keyword                 guifg=#00FFFF guibg=#000033
hi String                  guifg=#00CF00 guibg=#203320
hi Number                  guifg=#30D0EF guibg=#004063
hi Float                   guifg=#00D0DF guibg=#000083
hi Coditional              guifg=#FFFF00
hi Comment                 guifg=#00AF0A guibg=#003300
hi NonText                 guifg=#BB8800 guibg=#001002
hi MatchParen              guifg=#000000 guibg=#FFAF00
hi Search                  guifg=#EF80A0 guibg=#660040
hi IncSearch               guifg=#DFFF00 guibg=#AA6800

hi IndentGuidesOdd         guibg=#000033 ctermbg=3
hi IndentGuidesEven        guibg=#003066 ctermbg=4
hi PmenuSel                guifg=#DDDDDD guibg=#007A00
hi Pmenu                   guifg=#00DF00 guibg=#002400
hi EasyMotionTarget        ctermbg=none  ctermfg=blue       guibg=#AF0F00 guifg=#FFFF8F
hi EasyMotionShade         ctermbg=none  ctermfg=lightgreen guifg=#00BF00
...
hi Visual                  guibg=#A84400 guifg=NONE
hi LineNr                  guifg=#777700 guibg=#000033
hi DiffText                guifg=orange  guibg=#660000
hi DiffChange              guifg=NONE    guibg=#3F103F
hi DiffAdd                 guifg=NONE    guibg=#004488
hi DiffDelete              guifg=NONE    guibg=#440000
hi SpellBad                guifg=#CAA450 guibg=#630200
